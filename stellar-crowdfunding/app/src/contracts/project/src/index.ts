...
export interface Client {
   ...
   */
  init: ({title, description, image_url, creator, deadline}: {title: string, description: string, image_url: string, creator: string, deadline: i128}, options?: {
    /**
   ...
   */
  set_token: ({token_id}: {token_id: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  fund: ({from, amount}: {from: string, amount: i128}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
  ...
  /**
   * Construct and simulate a get_project_data transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  ...
  /**
   * Construct and simulate a get_total_funded transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  get_total_funded: (options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  get_contribution: ({funder}: {funder: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
  ...
  /**
   * Construct and simulate a get_all_contributions transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  get_all_contributions: (options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
...
export class Client extends ContractClient {
  ...
  public readonly fromJSON = {
    init: this.txFromJSON<null>,
        ...
        get_project_data: this.txFromJSON<ProjectData>,
        get_total_funded: this.txFromJSON<i128>,
        get_contribution: this.txFromJSON<i128>,
        get_all_contributions: this.txFromJSON<Map<string, i128>>,
