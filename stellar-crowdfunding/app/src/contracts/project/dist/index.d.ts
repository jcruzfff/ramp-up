...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CC2EAXLDNAJHV63F7Z52VQEPEXVEURPYNGYMFTHQ5KFIJP5DLEI26RUK";
    };
};
...
export interface Client {
     ...
     */
    init: ({ title, description, image_url, creator, deadline }: {
        title: string;
        description: string;
        image_url: string;
        creator: string;
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        ...
        get_project_data: (json: string) => AssembledTransaction<ProjectData>;
        get_total_funded: (json: string) => AssembledTransaction<bigint>;
        get_contribution: (json: string) => AssembledTransaction<bigint>;
        get_all_contributions: (json: string) => AssembledTransaction<Map<string, bigint>>;
